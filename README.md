...
auto_prepend_file = "C:\inetpub\wwwroot\prePHP2.php"
...
The correct version of str() will then be selected runtime, based on the type if the value passed in.
You can change the type of $x in disp() and it will still call the correct fucntion now for the new type.
